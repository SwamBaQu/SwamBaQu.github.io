...
<head>
    ...
    <script src="<?= URL_BASE_PATH ?>public/js/usuario/async.js"></script>
</head>
                ...
                <ul class="menuhorizontal" id="menuhorizontal">
                    ...
                    <li>
                        <div class="lisubcontenedor">
                            <a href="<?= URL_BASE ?>usuario/nuevo">CREAR USUARIOS</a>
                        </div>
                    </li>
                    <li>
                        <div class="lisubcontenedor">
                            <a href="<?= URL_BASE ?>usuario/listar">LISTAR USUARIOS</a>
                        </div>
                    </li>
    ...
    <main>
        <div class="formulariocontenedor">
            <div class="formulario">
                <div class="botonborrar" title="Eliminar Usuario">
                    <form action="<?= URL_BASE ?>usuario/borrar" method="post" id="FormBorrar">
                        <input type="hidden" id="id" name="id" value="<?= $usuario->getId() ?>">
                        <button type="button" value="Eliminar Usuario" id="BtnBorrar"><i class="fa-solid fa-trash-can" id="iconoBorrar"></i></button>
                    </form>
                </div>
                ...
                <form action="<?= URL_BASE; ?>usuario/modificar" method="post" id="FormModificar">
                        ...
                        <div class="abajo">
                            ...
                            <div class="campo">
                                ...
                                <input type="password" id="password" name="password"
                                    value="<?= $usuario->getPassword() ?>" required>
                                <span class="input-linea"></span>
                            </div>
                        </div>
                    </div>
