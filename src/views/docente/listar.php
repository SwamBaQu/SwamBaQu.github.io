        ...
        <div class="listacontenedor">
            <div class="lista">
                ...
                <div class="objetos">
                    ...
                    ?>
                        <a href="<?= URL_BASE; ?>docente/editar&ci=<?= $docente->getCi() ?>" title="Editar Docente" class="objetolink">
                            <div class="objeto">
                                <h2><?= htmlspecialchars($docente->getNombre()) ?></h2>
                                <p><?= htmlspecialchars($docente->getCi()) ?></p>
                            </div>
                        </a>
                    <?php
                    endforeach; ?>
