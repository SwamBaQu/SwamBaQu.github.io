...
<head>
    ...
    <script src="<?= URL_BASE_PATH ?>public/js/socio/async.js"></script>
</head>
    ...
    <main>
        <div class="formulariocontenedor">
            <div class="formulario">
                <div class="botonborrar" title="Eliminar Socio">
                    <form action="<?= URL_BASE ?>socio/borrar" method="post" id="FormBorrar">
                        <input type="hidden" id="id" name="id" value="<?= $socio->getId() ?>">
                        <button type="button" value="Eliminar Socio" id="BtnBorrar"><i class="fa-solid fa-trash-can" id="iconoBorrar"></i></button>
                    </form>
                </div>
                ...
                <form action="<?= URL_BASE; ?>socio/modificar" method="post" id="FormModificar">
                    ...
                    <div class="campos">
                        <div class="arriba">
                            ...
                            <div class="derecha">
                                ...
                                <div class="campo">
                                    <label for="infomedica">Información Médica</label>
                                    <input type="text" id="infomedica" name="infomedica" required
                                        value="<?= $socio->getInfomedica() ?>">
                                    <span class="input-linea"></span>
                                </div>
                            </div>
                        </div>
