        ...
        <div class="listacontenedor">
            <div class="lista">
                ...
                <div class="objetos">
                    ...
                    ?>
                        <a href="<?= URL_BASE; ?>evento/editar&id=<?= $evento->getId() ?>" title="Editar Evento" class="objetolink">
                            <div class="objeto">
                                <h2><?= htmlspecialchars($evento->getTitulo()) ?></h2>
                                <p><?= htmlspecialchars($evento->getHoraFecha()) ?></p>
                            </div>
                        </a>
                    <?php
                    endforeach; ?>
