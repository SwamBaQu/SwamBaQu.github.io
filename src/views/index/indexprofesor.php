...
<head>
    ...
    <link rel="stylesheet" href="<?= URL_BASE_PATH ?>public/css/indexprofesor.css">
...
<body>
        ...
        <div class="contenedorlogo" id="logo-header">
            <div class="headercontenedor">
                ...
                <div class="contenedordopa">
                    <a href="<?= URL_BASE ?>profesor/panelProfesor">
                        <img src="<?= URL_BASE_PATH ?>public/img/logos/DOPAv2darkU.png" alt="LogoDopa" class="logo">
                    </a>
                </div>
                <div class="contenedoriconos">
                    <a href="#" title="Mi Perfil" class="linkmiperfil"><img
                            src="<?= URL_BASE_PATH ?>public/img/perfil/iconoperfil.png" alt="ImagenPerfil"
                            class="imagenperfil"></a>
                </div>
            </div>
        </div>
                ...
                <ul class="menuhorizontal" id="menuhorizontal">
                    ...
                    <li>
                        <div class="lisubcontenedor">
                            <a href="<?= URL_BASE ?>profesor/panelProfesor" class="linknav">INICIO</a>
    ...
    <main>
        <div class="bienvenida">
            <h1> ¡BIENVENIDO AL CENTRO DE PROFESORES <br> DE DOPA!</h1>
        </div>
        <div class="barraseparacion"></div>
        <div class="contenedor">
            <div class="inscribirclases" id="clases">
                <div class="tituloclases">
                    <h2>¡Inscribite para ser profesor de nuestras clases!</h2>
                </div>
                <div class="contenidoclases">
                    <p>Inscribite para dar las clases que ofrecemos en DOPA.</p>
                    <p>Podés ver las clases en las que te podes inscribir, sus características, etc. Y podes inscribirte en la
                        que vos quieras.</p>
            ...
            <div class="inscribireventos" id="eventos">
                <div class="tituloeventos">
                    <h2>¡Inscribite para estar a cargo de nuestros eventos!</h2>
                </div>
                <div class="contenidoeventos">
                    <p>Inscribite para estar a cargo de los eventos que ofrecemos en DOPA.</p>
                    <p>Podés ver los eventos en los que te podes inscribir, sus características, etc. Y podes inscribirte en el
                        que vos quieras.</p>
                ...
                <div class="submainfooter">
                    <div class="empresa mainfooterson">
                        <div class="contenido empresason">
                            ...
                            <p>En DOPA ofrecemos una amplia gama de actividades diseñadas para todos los gustos y
                                ...
                                padre o madre que busca actividades para sus hijos, siempre tenemos algo especial para
                                vos.
                            </p>
                            <div class="redes">
                    ...
                    <div class="sedes mainfooterson">
                        <div class="contenido sedesson">
                            ...
                            <h4>Sede San José</h4>
                            <p><i class="fa-solid fa-location-dot"></i> Dr. E. G. Ciganda 617, 80000 San José de Mayo
                            </p>
                            <p><i class="fa-solid fa-phone"></i> +598 2480 8302</p>
                            <p><i class="fa-solid fa-clock"></i> Lunes a Viernes de 6:30 a 22:30 <br> Sábado de 8 a 20
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="app mainfooterson">
                        <div class="contenido appson">
                            <h4>Aplicación Móvil</h2>
                                ...
                                <p>¡Llevá tu entrenamiento al siguiente nivel con nuestra Aplicación Móvil! Reservá
                                    clases,
