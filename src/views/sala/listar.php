        ...
        <div class="listacontenedor">
            <div class="lista">
                ...
                <div class="objetos">
                    ...
                    ?>
                        <a href="<?= URL_BASE; ?>sala/editar&id=<?= $sala->getId() ?>" title="Editar Sala" class="objetolink">
                            <div class="objeto">
                                <h2><?= htmlspecialchars($sala->getNombre()) ?></h2>
                                <p><?= htmlspecialchars($sala->getUbicacion()) ?></p>
                            </div>
                        </a>
                    <?php
                    endforeach; ?>
