document.addEventListener('DOMContentLoaded', () => {
    ...
    const  inputDeshabilitar = document.getElementById('sala');
    ...
    async function editarFormulario() {
        try {
            ...
            let url = urlbase + "sala/modificar";
    ...
    function desableInput(inputDeshabilitar){
        $(inputDeshabilitar).disabled = false;
    }
});
